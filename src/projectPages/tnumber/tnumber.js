...
import "./tnumber.css";
import mainimg from "../../assest/project-images/tnumber.png";
import vector from "../../assest/project-images/tnumber-icon.png";
...
import calvaryViedio from "../../assest/ProjectViedios/tnumber.MOV";
...
const TnumberComponent = () => {
  ...
  return (
    <div>
      <div className="tnuberTop">
        <div className="row">
          <div className="col-md-12 col-sm-12 col-lg-6">
            <div className="top-content">
              <img src={vector} width={"12%"} alt="" />
              <h2 className="my-3">Tnumber Rewards</h2>
          ...
          <div className="col-md-12 col-sm-12 col-lg-6 d-flex justify-content-start aling-items-center">
            <img
              style={{ marginTop: "16%" }}
              src={mainimg}
              width={"90%"}
        ...
        <div className="Mobile-Section text-center container">
          <div className="row my-5 justify-content-center">
            ...
            <div className="col-md-12 col-lg-4">
              <img className="mb-3" src={one} width={"15%"} alt="" />
            ...
            <div className="col-md-12 col-lg-4">
              <img className="mb-3" src={two} width={"15%"} alt="" />
          ...
          <div className="row my-5 justify-content-center">
            <div className="col-md-12 col-lg-3">
              <img className="mb-3" src={three} width={"20%"} alt="" />
            ...
            <div className="col-md-12 col-lg-3">
              <img className="mb-3" src={four} width={"20%"} alt="" />
...
export default TnumberComponent;
