...
import mainimg from "../../assest/web-icons/chatie/Group 1000005593.png";
      ...
      <div className="trademarkTop">
        <div className="row container">
          <div className="col-md-12 col-sm-12 col-lg-6">
            <div className="top-content">
              ...
              <h2 className="my-3">TradeMark Cockpit</h2>
        ...
        <div className="boxe">
          ...
          <div className="plateform-box text-center ms-4">
            ...
            <p>PHP, Laravel, SQL, Html, Css, Javascript, Jquery, etc..</p>
          </div>
        </div>
      </div>
