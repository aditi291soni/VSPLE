...
import "./qrscape.css";
import mainimg from "../../assest/web-icons/qrscape/Group 1000005579.png";
import vector from "../../assest/web-icons/qrscape/Mask group.png";
...
import breckworldViedio from "../../assest/ProjectViedios/qrscape.mp4";
...
import mobile from "../../assest/web-icons/qrscape/Group 1000005219.png";
...
const QrscapeComponent = () => {
  ...
  return (
    <div>
      <div className="qrscapeTop">
        <div className="row container">
          <div className="col-md-12 col-sm-12 col-lg-6">
            <div className="top-content">
              <img src={vector} width={"20%"} alt="" />
              <h2 className="my-3">QRscape</h2>
      ...
      <div className="section-2 container">
        <div className="row">
          <div className="col-md-12 col-lg-6 p-none p-lg-5">
            ...
            <p>
              In a world driven by digital connectivity, the traditional methods
              of sharing contact information can be cumbersome and
              time-consuming. Exchanging business cards or typing out contact
              details manually can lead to errors and inefficiencies. There was
              a need for a modern solution that would simplify and enhance the
              process of sharing personal contact information seamlessly.
            </p>
          </div>
          <div className="col-md-12 col-lg-6 p-none p-lg-5">
            <h4>
            ...
            <p>
              Introducing QRscape, an innovative app designed to revolutionize
              the way you share your personal contact information. QRscape
              addresses the challenges of traditional contact sharing by
              providing a streamlined and efficient method using QR codes. This
              solution ensures accuracy, speed, and a personalized experience
              for users, whether they are connecting with customers, friends, or
              clients.
            </p>
          </div>
        </div>
        <div className="mt-5 container">
          <div className="row introduction">
            ...
            <div className="col-md-8 col-sm-12 text-left">
              <h4>Client</h4>
              <p>
                QRscape is a cutting-edge application developed by Vsple
                Technologies Pvt. Ltd. The app is dedicated to making contact
                sharing easy and hassle-free. It leverages the latest
                technologies and features to provide a seamless user experience.
                QRscape is available for download on the App Store, catering to
                iOS users who seek a modern and efficient way to exchange
                contact details.
              </p>
            </div>
          </div>
              ...
              <div className="single-t my-5">
                <div className="single-testimial-box">
                  <p className="text-light">
                    It was a pleasure to work with Vsple, and no doubts: I will
                    make my next project with them. They are answered in short
                    time and give good proposal to solve problems.
                  </p>
                </div>
              </div>
            </div>
...
export default QrscapeComponent;
