                ...
                >
                  ...
                  <div className="col-md-12 col-lg-5 col-sm-12">
                    <div className="main-text">
                      ...
                      <p>Our intention to stand out in the industry
                        by offering vibrant and remarkable digital experiences
                        that leave a lasting positive impression on our clients.
                        We strives to create IT solutions that are not only
                        visually captivating but also surpass clients'
                        expectations in terms of excellence.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div id="h0" className="service-box">
                ...
                <div className="getin-button text-center mt-4 web-model">
                  <div className="see-button">
                    <a href="/mobile-app-development-services">View All &nbsp;</a>
                    <svg
