...
const QaDevComponent = () => {
  ...
  const [faqs, setFaqs] = useState([
    {
      question: "What does Quality Assurance (QA) mean in the context of Vsple Technologies Pvt. Ltd.?",
      answer:
    ...
    {
      question: "How does QA contribute to the success of my project with Vsple Technologies?",
      answer: "QA is the backbone of our commitment to delivering top-notch software. It's the key to identifying and resolving potential issues early in the development cycle, ensuring a seamless and reliable end product.",
      open: false,
    },
    {
      question:
        "What is the unique approach of Vsple Technologies in the QA process?",
      answer: "At Vsple, we take a tailored approach to QA, aligning our strategies with the specific needs of your project. This ensures that the testing process is comprehensive and focused on the critical aspects of your software",
      open: false,
    },
    {
      question:
        "Can you highlight the types of testing covered by Vsple's QA services?",
      answer: "Our QA services encompass a spectrum of testing, including functional, performance, security, and usability testing. This holistic approach guarantees that your software meets not only the functional requirements but also performance and security standards.",
      open: false,
    },
  ]);
