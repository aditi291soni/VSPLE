  ...
  const accordionData = [
    {
      title: (
        <div className="h-feature-list">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Discovery Phase: Understanding Your
          Vision
          <img
        ...
        <div className="hidden header row align-items-center ">
          <div className=" col-md-6 d-flex justify-content-start align-items-center">
            <div className="main-text-service">
              ...
              <p>
                At Vsple Technologies, we redefine digital experiences through
                cutting-edge UI/UX design. Our dedicated team of experts
                combines creativity and technical proficiency to elevate your
                digital presence. Discover how our UI/UX services can transform
                your vision into a captivating and user-friendly reality.
              </p>
            ...
            <div className=" key-text-div col-md-12 col-sm-12 col-lg-6 d-flex align-items-start justify-content-end">
              <div className="main-text-service m-0">
                ...
                <ul className="ps-4 mt-3">
                  <li className="active-li">Strategic Design Thinking</li>
                  <p>
                    Our approach goes beyond aesthetics. We align every design
                    element with your business goals, ensuring a seamless blend
                    of functionality and aesthetics.
                  </p>
                  <hr />
                  <li className="active-li">User-Centric Solutions</li>
                  <p>
                    {" "}
                    Putting your users first is our mantra. We create interfaces
                    that resonate with your audience, enhancing user
                    satisfaction and engagement.
                  </p>
                  <hr />
                  <li className="active-li">Innovative Concepts</li>
                  <p>
                    {" "}
                    Stay ahead of the curve with our innovative design concepts.
                    We bring fresh ideas to the table, ensuring your digital
        ...
        <div className="container  hidden">
          <div className="h-journey d-flex justify-content-center text-center hidden howWorks">
            <div className="p-journey">
              ...
              <p>
                At Vsple Technologies, we are passionate about crafting digital
                experiences that seamlessly blend UX functionality with UI
                aesthetics. In the dynamic realm of digital experiences, UI and
                UX stand as pillars that determine the success of any product.
          ...
          <div className="h-leader-row row pt-5 pb-5">
            <div className=" col-md-6 col-sm-12 col-lg-6 ">
              <div className="p-leader mt-5">
                ...
                <p>
                  In UI/UX design projects, a diverse tech stack is employed to
                  streamline the creation of visually appealing and
                  user-friendly interfaces. Design tools like Sketch, Adobe XD,
                  or Figma are utilized for wireframing, prototyping, and
                  creating mockups, enabling designers to iterate rapidly and
          ...
          <div className=" key-text-div col-md-12 col-sm-12 col-lg-6 d-flex align-items-start justify-content-center">
            <div className="key-text">
              <div className="center">
                ...
                <span>How We Design For Our Clients</span>
              </div>
        ...
        <div className="parent">
          <div className="child1">
            ...
            <div className="pt-4 px-3">
              ...
              <p className="my-2">
                TicTacToe is played by two players on a grid of three-by-three,
                who alternately place the marks X (FIRE) and O (WATER) in one of
                the nine spaces in the grid. As there are no universal rules to
                who plays first. Players shortly discover the best play from
                both parties leading to a draw.
              </p>
              <div className="getin-button text-center">
                <div className="see-button">
