...
const WebsiteDevComponent = () => {
  ...
  const [faqs, setFaqs] = useState([
    ...
    },
    {
      ...
      answer:
        "Our website development service is comprehensive and covers everything from initial design and development to ongoing maintenance and support. We create custom websites tailored to your unique requirements, ensuring they are user-friendly, mobile-responsive, and optimized for search engines.",
      open: false,
    },
    {
      question: "How long does it take to develop a website?",
      answer:
        "The timeline for website development varies depending on the complexity of the project. Simple websites can be completed in a few weeks, while more complex projects may take a few months. We will provide you with a clear project timeline during the consultation phase.",
      open: false,
    },
    {
      question: "What is the cost of website development?",
      answer:
        "The cost of website development can vary widely based on the scope of the project. Our pricing is flexible and depends on factors such as the size and functionality of the website. We offer transparent pricing and will provide you with a detailed quote after discussing your specific needs.",
      open: false,
    },
    {
      question: "Do you offer e-commerce website development services?",
      answer:
        "Yes, we specialize in e-commerce website development. Our team has extensive experience in creating secure and user-friendly online stores that can help you sell products or services efficiently.",
      open: false,
    },
  ]);
        ...
        <div className="main-boxes hidden container">
          <div className="row">
            <div className="b">
              ...
              <p>
                We start every web development project by thoroughly
                understanding your business goals, target audience, and
                industry. Our team collaborates closely with you to gather
                insights that inform the design and functionality of your
                website. This understanding serves as the foundation for a
            ...
            <div className="b">
              ...
              <p>
                With a clear understanding of your business, we create a
                strategic plan that outlines the project's scope, timeline, and
                goals. We set measurable objectives to ensure that the final
                product aligns with your business objectives, whether it's
                driving sales, increasing brand awareness, or providing a
            ...
            <div className="b">
              ...
              <p>
                Our web development approach places a strong emphasis on user
                experience and design. We create visually appealing, intuitive,
                and responsive websites that engage your audience and encourage
                them to take action. Our team ensures that your website is not
                only visually stunning but also easy to navigate, regardless of
            ...
            <div className="b">
              ...
              <p>
                We understand that one size does not fit all. Our web
                development team specializes in custom solutions tailored to
                your specific needs. Whether you require an e-commerce platform,
                a content management system, or a web application, we'll build
                it from the ground up to match your requirements.
              </p>
            </div>
            <div className="b">
              ...
              <p>
                Quality is a top priority for us. We rigorously test every
                aspect of your website to ensure it functions flawlessly across
                various browsers and devices. Our QA process guarantees that
                your website performs reliably, loads quickly, and is free from
            ...
            <div className="b">
              ...
              <p>
                Once your website is live, our commitment doesn't end. We offer
                ongoing support and maintenance services to keep your website up
                to date, secure, and optimized for peak performance. We are here
                to assist you whenever you need updates or improvements.
              </p>
            </div>
          </div>
        </div>
