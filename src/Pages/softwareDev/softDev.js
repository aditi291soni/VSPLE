...
const SoftwareDevComponent = () => {
  ...
  const [faqs, setFaqs] = useState([
    ...
    {
      question: "What is the typical duration for a software development project?",
      answer:
          ...
          <div className="slide-trackN">
            ...
            <div className="slideN">
              <div className="service-box-slider p-4">
                ...
                <p className="slider-title-p">
                  Discover the art of impactful web presence with Vsple Technologies. Our expert web developers blend...
                </p>
                <a href="/website-development-services">Read More</a>
              </div>
            </div>
